...
\begin{description}
\item[\refstepcounter{acnum} \actheacnum \label{acNumSteps}:] The maximum number of steps we upper bound our program by may change. This is largely due to computational demands and how feasible these computations are with respect to this parameter.
\item[\refstepcounter{acnum} \actheacnum \label{acMinError}:] The minimum threshold of error of our program may change. This is largely due to computational demands and how feasible these computations are with respect to this parameter.
\item[\refstepcounter{acnum} \actheacnum \label{acMaxDim}:] The maximum dimension of we upper bound our program by may change. This is largely due to computational demands and how feasible these computations are with respect to this parameter.
\end{description}
...
\begin{description}
\item[\refstepcounter{ucnum} \uctheucnum \label{ucNumFunc}:] The number of optimizers in our library will likely not change.
\end{description}
...
\begin{description}
\item [\refstepcounter{mnum} \mthemnum \label{moduleHH}:] Hardware-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleMain}:] Main Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleParamConfig}:] Parameter Configuration Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleVecMath}:] Vector Math Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleGradCalc}:] Gradient Calculator Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleStepSize}:] Step Size Calculator Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleSearchDir}:] Search Direction Calculator Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleInputVerify}:] Input Verify Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleOutputVerify}:] Output Verify Module
\item [\refstepcounter{mnum} \mthemnum \label{moduleOptimizer}:] Optimization Solver Module
\end{description}
